package com.leven.demoplus.crypto.aes;
...
public class AesUtils {
  ...
  public static String Encrypt(String src, String key) throws Exception {
    ...
    for (int i = 0; i < 16; i++) {
      if (data.length > i) raw[i] = data[i];
      else raw[i] = plusbyte[0];
    }
  ...
  public static byte[] toByteArray(String hexString) {
    if (hexString.isEmpty()) throw new IllegalArgumentException("this hexString must not be empty");
  ...
  public void testDecript() throws Exception {
    String encrypt = AesUtils.Encrypt("123456", "456");
    String decrypt = AesUtils.Decrypt(encrypt, "456");
